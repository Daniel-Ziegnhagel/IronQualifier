...
using Rez;
// using Log4MonkeyC as Log;  <--- Entfernt
...
class IronmanApp_siebenSwimView extends WatchUi.View {
    ...
    function onUpdate(dc as Graphics.Dc) as Void {
        ...
        if (positionInfo != null && positionInfo.speed != null) {
            ...
            System.println("Rohgeschwindigkeit (m/s): " + rawSpeed);
            currentSpeed = rawSpeed * 3.6;  // in km/h
            System.println("Umgerechnete Geschwindigkeit (km/h): " + currentSpeed);

            // Validierung
            if (currentSpeed < 0 || currentSpeed > 1000) {
                System.println("Unrealistische Geschwindigkeit erkannt: " + currentSpeed);
                currentSpeed = 0.0;
            }
        }
